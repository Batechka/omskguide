    ...
    <div class="container">
        ...
        <div class="faq-grid">
            <?php if ($lang == 'ru'): ?>
                ...
                <div class="faq-item">
                    <div class="faq-question">Где погулять в Омске?</div>
                    <div class="faq-answer">Иртышская набережная, парк «Зеленый остров», сквер им. Дзержинского — отличные места для прогулок и досуга.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">Какой досуг доступен в Омске?</div>
                    <div class="faq-answer">В Омске разнообразный досуг: от пеших экскурсий по историческому центру до посещения театров, музеев и современных арт-пространств. Каждый найдёт занятие по душе.</div>
                </div>
            <?php else: ?>
                <div class="faq-item">
